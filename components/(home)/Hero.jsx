                    ...
                    >
                        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center py-20">
                            ...
                            <motion.div variants={fadeInLeft} className="space-y-8">
                                ...
                                <p className="text-base md:text-lg text-gray-600 dark:text-gray-300 leading-relaxed tracking-normal md:tracking-wide text-left md:text-justify max-w-full break-words hyphens-auto px-2 md:px-0">
